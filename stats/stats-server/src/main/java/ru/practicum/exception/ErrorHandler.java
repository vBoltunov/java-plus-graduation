...
public class ErrorHandler {
    ...
    public ApiError validationException(Exception exception) {
        ...
        return new ApiError(HttpStatus.BAD_REQUEST, "exception", exception.getMessage(), stackTrace);
    }
    ...
    public ApiError internalServerException(Exception exception) {
        ...
        exception.printStackTrace(printWriter);
        String stackTrace = writer.toString();
        return new ApiError(HttpStatus.INTERNAL_SERVER_ERROR, "exception", exception.getMessage(), stackTrace);
    }
